      ...
      <div className="px-3 md:px-28 pb-10 md:pb-16 pt-2 h-full">
        <div className="mt-10 md:mt-20 grid grid-cols-1 md:grid-cols-4 gap-10 items-center text-center">
          <Link to="/businessmanage">
            <div className="py-9 px-9 bg-base-100 hover:bg-secondary duration-500  mx-auto rounded-xl shadow-xl text-secondary hover:text-base-100">
          ...
          <Link to="/digitalmarketing">
            <div className="px-14 py-9 bg-base-100 mx-auto rounded-xl shadow-xl text-secondary hover:bg-secondary hover:text-base-100 duration-500">
          ...
          <Link to="/mobileapp">
            <div className="px-7 py-10 bg-base-100 rounded-xl shadow-xl text-secondary hover:bg-secondary hover:text-base-100 duration-500">
              <img className="w-16 mx-auto mb-2" src={service3} alt="" />
              <p>Mobile app & Web Development</p>
            </div>
          </Link>
          <Link to="/ecommerce">
            <div className="py-12 bg-base-100 rounded-lg shadow-xl text-secondary hover:bg-secondary hover:text-base-100 duration-500">
              <img className="w-16 mx-auto mb-2" src={service4} alt="" />
              <p>E-Commerce Solution</p>
            </div>
          </Link>
          <Link to="/affiliate">
            <div className="py-10 px-7 bg-base-100 shadow-xl rounded-lg text-secondary hover:bg-secondary hover:text-base-100 duration-500">
              <img className="w-24 mx-auto mb-2" src={service5} alt="" />
              <p>Affiliate Marketing Solutions</p>
            </div>
          </Link>
          <Link to="/adnetwork">
            <div className="py-12 px-8 rounded-lg shadow-xl bg-base-100 text-secondary hover:bg-secondary hover:text-base-100 duration-500">
