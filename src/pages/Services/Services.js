...
const Services = () => {
  return (
    <div>
      <SubNavbar></SubNavbar>
      <div className="px-3 md:px-28 pb-5 pt-2 h-screen service-container">
        <div className="mt-10 md:mt-20 grid grid-cols-1 md:grid-cols-4 gap-10 items-center text-center">
          ...
          <Link to="/mobileapp">
            <div className="px-7 py-10 bg-base-100 rounded-xl text-secondary hover:bg-secondary hover:text-base-100 duration-500">
              <img className="w-16 mx-auto mb-2" src={service3} alt="" />
              <p>Mobile app & Web Development</p>
            </div>
          </Link>
          <Link to="/ecommerce">
            <div className="py-12 bg-base-100 rounded-lg text-secondary hover:bg-secondary hover:text-base-100 duration-500">
              <img className="w-16 mx-auto mb-2" src={service4} alt="" />
              <p>E-Commerce Solution</p>
            </div>
          </Link>
          <Link to="/affiliate">
            <div className="py-10 px-7 bg-base-100 rounded-lg text-secondary hover:bg-secondary hover:text-base-100 duration-500">
              <img className="w-24 mx-auto mb-2" src={service5} alt="" />
              <p>Affiliate Marketing Solutions</p>
            </div>
          </Link>
          <Link to="/adnetwork">
            <div className="py-12 px-8 rounded-lg bg-base-100 text-secondary hover:bg-secondary hover:text-base-100 duration-500">
